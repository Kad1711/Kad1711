...
`Figma` • `Canva Pro` • `Git` • `GitHub` • `VS Code` • `Visual Studio` • `Postman`
...
<p align="center">
  ...
  />
  <img
    src="https://github-readme-stats.vercel.app/api/top-langs/?username=Kad1711&layout=compact&hide_border=true"
    height="165"
  />
</p>
